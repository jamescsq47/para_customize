...
class WanPipeline_NEW(DiffusionPipeline):
    ...
    def __call__(
        ...
        # torch.save(total_time_list, "/mnt/public/chensiqi/ParaAttention/results/parallel/total_time_list_8.pt")
        # plt.figure()
        ...
        # plt.grid(True)
        # plt.savefig('/mnt/public/chensiqi/ParaAttention/results/parallel/timestep_wan8.png')
        # plt.close()
...
class WanPipeline_PARO(DiffusionPipeline):
    ...
    def __call__(
        ...
        # plt.title('Total Attention Time per Timestep')
        # plt.grid(True)
        # plt.savefig('/mnt/public/chensiqi/ParaAttention/results/parallel/timestep_wan3.png')
        # plt.close()
